...
pub enum Expression {
    ...
    Definition { formals: (Vec<Expression>, Option<Box<Expression>>), body: Box<Expression> },
        ...
        match &stx.e {
            ...
            Datum::ImproperList => {
                match self.qquote_syntax_list(stx, depth)? {
                    Expression::Literal(Literal::Clone(LiteralD::List(mut ee, None))) => {
